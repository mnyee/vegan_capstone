...
// 리뷰 등록
    ...
    */
    ...
    //var_dump( isset($_FILES['imgFile']));
    //var_dump( isset($_FILES['imgFile']['tmp_name']));

    if(isset($_FILES['imgFile']) && isset($_FILES['imgFile']['tmp_name']) && strlen($_FILES['imgFile']['tmp_name'])>0) {
    ...
    $sql1 = "INSERT INTO review (`title`, `body`, `img`, `phone`) VALUES ('$title', '$body', '$resFileName', '$phone');";
    //echo "$sql1";
    ...
    $sql3 = "SELECT num, title, body, img, phone FROM review WHERE `phone` = $phone ORDER BY `num` DESC LIMIT 1"; 
